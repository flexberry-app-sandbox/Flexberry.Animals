...
namespace IIS.Animals
{
    ...
    public class Burrow : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Animals.Forest fForest;
        
        private IIS.Animals.Animal fAnimal;
        ...
        [PropertyStorage(new string[] {
                "Forest"})]
        [NotNull()]
        public virtual IIS.Animals.Forest Forest
        {
            get
            {
                ...
                IIS.Animals.Forest result = this.fForest;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Animals.Animal.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Animal"})]
        public virtual IIS.Animals.Animal Animal
        {
            get
            {
                ...
                IIS.Animals.Animal result = this.fAnimal;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View BurrowE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("BurrowE", typeof(IIS.Animals.Burrow));
                }
            }
        }
    }
    ...
    public class DetailArrayOfBurrow : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Animals.DetailArrayOfBurrow members)

        // *** End programmer edit section *** (IIS.Animals.DetailArrayOfBurrow members)
        ...
        /// </summary>
        public DetailArrayOfBurrow(IIS.Animals.Animal fAnimal) : 
                base(typeof(Burrow), ((ICSSoft.STORMNET.DataObject)(fAnimal)))
        {
        }
        
        public IIS.Animals.Burrow this[int index]
        {
            get
            {
                return ((IIS.Animals.Burrow)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Animals.Burrow dataobject)
        {
